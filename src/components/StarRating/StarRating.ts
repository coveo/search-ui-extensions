import { $$, Utils, Component, Initialization, ComponentOptions, IComponentBindings } from 'coveo-search-ui';
...
export class StarRating extends Component {
     ...
     */
    constructor(public element: HTMLElement, public options: IStarRatingOptions, public bindings?: IComponentBindings) {
